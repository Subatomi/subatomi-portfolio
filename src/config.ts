    ...
    projects:[
        {
            ...
            technologies: ["Vite", "React", "TypeScript", "Tailwind CSS", "GSAP", "Vercel"],
            image: [
            ...
            description: "Personal portfolio website built with React and Vite. Showcases projects, and a responsive, accessible UI. Includes animated reveals, image lightbox, client-side routing, and contact links. Deployed on Vercel.",
            link: "",
